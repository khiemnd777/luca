...
registerTable("dentist-orders", () =>
  createTableSchema<OrderModel>({
    columns,
    fetch: async (opts: FetchTableOpts & Record<string, any>) => await orderTableByDentistId(Number(opts.dentistId), opts),
    initialPageSize: 10,
